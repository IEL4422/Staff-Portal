...
const ALLOWED_DOMAIN = 'illinoisestatelaw.com';
...
const SignUpPage = () => {
  ...
  const emailDomainValid = !email || email.toLowerCase().endsWith(`@${ALLOWED_DOMAIN}`);
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <img
            src="https://i.imgur.com/pKy65wF.png"
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className={`h-11 ${email && !emailDomainValid ? 'border-red-400 focus-visible:ring-red-400' : ''}`}
                />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className={`h-11 pr-10 ${password && !passwordLongEnough ? 'border-red-400 focus-visible:ring-red-400' : ''}`}
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className={`h-11 ${confirmPassword && !passwordsMatch ? 'border-red-400 focus-visible:ring-red-400' : ''}`}
                />
              ...
              <Button
                ...
                disabled={loading || !emailDomainValid || !passwordsMatch || !passwordLongEnough}
              >
                {loading ? (
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-500">
                ...
                <Link to="/login" className="text-[#2E7DA1] hover:underline font-medium">
                  Sign in
                </Link>
              </p>
            </div>
